...
**Cloud Identity API**. These API methods are available only to service accounts
belonging to specific Google Workspace plans:
...
Regardless of your plan, we recommend blocking access to external groups at the
workspace level (following
[these instructions](https://support.google.com/a/answer/9468710)) to prevent
unexpected results when Teleport queries group memberships.
