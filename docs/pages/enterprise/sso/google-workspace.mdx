...
### Choose your Google Workspace API

{/* TODO: 

Change this to a section that 

(a) lays out the rules re: transitive groups first
(b) indicates up front how to configure Google Workspace or your connector
  to use one API instead of another.
*/}
