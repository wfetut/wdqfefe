...
| [Approval Plugins](../access-controls/access-requests/index.mdx) | Plugins to approve or deny escalated RBAC requests. |
...
See the [SSO for SSH](../access-controls/single-sign-on/index.mdx) chapter for more details.
...
Read the [Access Requests Guide for more information](../access-controls/access-requests/index.mdx) for more information.
