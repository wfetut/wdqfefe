...
Follow [adding users](enterprise/quickstart-enterprise.mdx#step-33-adding-users) or integrate with [Google Workspace](access-controls/single-sign-on/google-workspace.mdx) to provide SSO access.
...
Read [adding users](enterprise/quickstart-enterprise.mdx#step-33-adding-users) or integrate with [Google Workspace](access-controls/single-sign-on/google-workspace.mdx) to provide SSO access.