...
## Managing and recording sessions
...
## Using Teleport with legacy OpenSSH setups

<TileSet>
  <Tile icon="server" title="Using Teleport with sshd" href="./guides/openssh-server.mdx">
    How to join sshd servers to a Teleport cluster.
  </Tile>
  <Tile icon="server" title="Using Teleport with OpenSSH Clients" href="./guides/openssh-client.mdx">
    How to use Teleport on legacy systems with OpenSSH clients.
  </Tile>
</TileSet>

## Server Access integrations
