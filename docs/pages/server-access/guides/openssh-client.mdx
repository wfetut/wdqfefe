...
Save the address of your <ScopedBlock scope="cloud">Teleport Cloud
...
```code
$ export ADDR=tele.example.com:3025
```
...
Start your Node with the invite token:
...
## Step 2/ . Generate an SSH client configuration
