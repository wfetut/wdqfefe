...
*external* users via [Github](#github-oauth-20) or [Okta](access-controls/single-sign-on/okta.mdx) or any other
...
| connector | Authentication connectors for [Single Sign-On](access-controls/single-sign-on/index.mdx) (SSO) for SAML, OIDC and Github. |
