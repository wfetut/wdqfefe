...
<Tabs>
  ...
  <TabItem label="Enterprise">
    Follow [SAML Okta Guide](../access-controls/single-sign-on/okta.mdx#configure-okta) to create a SAML app.
    Check out [OIDC guides](../access-controls/single-sign-on/oidc.mdx#identity-providers) for OpenID Connect apps.
