...
<Details
  ...
  scopeOnly={true}
>
Azure database auto-discovery is available starting from Teleport `10.2`. Database
access for Azure PostgreSQL/MySQL flexible servers is available starting from
Teleport `12.0`.

</Details>

This guide will help you to set up secure access and connect through Teleport
to Azure PostgreSQL and MySQL servers.
