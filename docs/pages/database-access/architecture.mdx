...
description: How the Teleport Database Service works.
---

This section provides an overview of Teleport Database Service's inner workings.

## How it works

Let's take a look at a sample Database Service deployment:
