...
description: How to use Teleport Access Requests and Plugins.
h1: Teleport Access Requests
---

<TileSet>
  <Tile icon="lock" title="Jira Cloud Plugin" href="./jira-cloud.mdx">
    Jira Cloud Plugin.
  </Tile>
  <Tile icon="lock" title="Jira Server Plugin" href="./jira-server.mdx">
    Jira Server Plugin.
  </Tile>
  <Tile icon="lock" title="Mattermost Plugin" href="./mattermost.mdx">
    Mattermost Plugin.
  </Tile>
  <Tile icon="lock" title="PagerDuty Plugin" href="./pagerduty.mdx">
    PagerDuty Plugin.
  </Tile>
  <Tile icon="lock" title="Slack Plugin" href="./slack.mdx">
    Slack Plugin.
  </Tile>
</TileSet>
...
| - | - | - | - |
| Slack | | Chatbot | [Setup Slack](../access-requests/slack.mdx) |
| Mattermost | | Chatbot | [Setup Mattermost](mattermost.mdx) |
| Jira Server | | Project Board | [Setup Jira Server](jira-server.mdx) |
| Jira Cloud | | Project Board | [Setup Jira Cloud](jira-cloud.mdx) |
| PagerDuty | | Schedule | [Setup PagerDuty](pagerduty.mdx) |