...
usable within roles. The preset `access` role has this variable that will automatically include the
GitHub user as an authorized SSH login. Here is an example role configuration snippet using the trait. 
