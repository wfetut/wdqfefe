...
`tlsFromSecret` is the name of the Kubernetes secret containing TLS credentials
for the webhook: `teleport-plugin-jira-tls`.
...
teleport-plugin-jira   LoadBalancer   10.100.213.245   00000000000000000000000000000000000000000.us-west-2.elb.amazonaws.com   443:30720/TCP   53s
```
