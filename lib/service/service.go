...
func (process *TeleportProcess) getAdditionalPrincipals(role types.SystemRole) ([]string, []string, error) {
	...
	// Add default participant list to the addrs list.
	// For identity generated by teleport <= v6.1.6  the teleport.cluster.local participant is not present
	// and after upgrading teleport to newer version the identity needs to be regenerated.
	for _, v := range auth.DefaultParticipantForRole(role) {
