...
func (a *Server) UpdateUserPreferences(ctx context.Context, request *userpreferencesv1.UpdateUserPreferencesRequest) error {
	return trace.Wrap(a.Services.UpdateUserPreferences(ctx, request))
}
