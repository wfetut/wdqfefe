...
func (c *TransportCredentials) authorize(ctx context.Context, remoteAddr net.Addr, identityGetter IdentityGetter, connState *tls.ConnectionState) (*Context, error) {
	if c.authorizer == nil {
		return &Context{
