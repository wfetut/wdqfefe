...
const (
	...
	UserPreferencesService_UpdateUserPreferences_FullMethodName = "/teleport.userpreferences.v1.UserPreferencesService/UpdateUserPreferences"
)
...
func (c *userPreferencesServiceClient) UpdateUserPreferences(ctx context.Context, in *UpdateUserPreferencesRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, UserPreferencesService_UpdateUserPreferences_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserPreferencesServiceServer) UpdateUserPreferences(context.Context, *UpdateUserPreferencesRequest) (*emptypb.Empty, error) {
